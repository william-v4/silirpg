...
/** @type {string} */
const CACHE_VERSION = '1734464666|181472755';
/** @type {string} */
const CACHE_PREFIX = 'silirpg-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'silirpgweb.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["silirpgweb.html","silirpgweb.js","silirpgweb.offline.html","silirpgweb.icon.png","silirpgweb.apple-touch-icon.png","silirpgweb.worker.js","silirpgweb.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["silirpgweb.wasm","silirpgweb.pck"];
